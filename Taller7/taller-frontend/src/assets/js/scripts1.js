...
form.addEventListener('submit', (event) => {
    ...
    validation(
        name, [formObj['name'] == '', formObj['name'].length > 20], ['Campo obligatorio', 'Longitud máxima: 20']
    );

    validation(
        lastname, [formObj['lastname'] == '', formObj['lastname'].length > 68], ['Campo obligatorio', 'Longitud máxima: 68']
    );
});
